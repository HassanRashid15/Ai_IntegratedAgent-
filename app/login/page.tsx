...
import { Mail, ArrowRight, CheckCircle, AlertCircle, User, LogOut, Shield, Lock, Eye, EyeOff } from "lucide-react";
          ...
          {!sb ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Set up Supabase environment variables to enable login
              </p>
            </div>
          ) : (
